...
\subsection*{1. Thời gian thành lập}
\vspace{-0.6\baselineskip}
Thứ 4, Ngày 3 tháng 12 năm 2025.

\subsection*{2. Thời hạn hợp đồng}
\vspace{-0.6\baselineskip}
Đến khi hoàn thành ĐỒ ÁN CUỐI KỲ -- Môn Kỹ Năng Nghề Nghiệp.

\subsection*{3. Tên nhóm}
\vspace{-0.6\baselineskip}
\textbf{5 ducks}

\subsection*{4. Thành viên}
...
\subsection*{5. Mục đích thành lập}
\begin{itemize}
...
\subsection*{6. Vai trò của các thành viên trong nhóm}
\vspace{0.3cm}
...
\subsection*{7. Mô tả dự án Tetris}
\vspace{-0.2\baselineskip}
...
\noindent\textbf{Công nghệ sử dụng}: Ngôn ngữ lập trình C++ với thư viện hệ thống POSIX (termios, fcntl) để xử lý terminal và đầu vào.


\subsection*{8. Hiệp định nhóm}
\vspace{-0.6\baselineskip}
\begin{itemize}
...
\subsection*{9. Không gian sinh hoạt và trao đổi của nhóm}
...
\subsection*{10. Tiêu chí đánh giá các thành viên}
...
\noindent Điểm đặc biệt của dự án là chúng tôi phát triển \textbf{hai phiên bản song song}:
\vspace{-0.8\baselineskip}
\begin{itemize}
...
\noindent Việc phát triển hai phiên bản giúp chúng tôi:
\vspace{-0.6\baselineskip}
\begin{itemize}
...
\noindent Dự án này không chỉ là một trò chơi giải trí, mà còn là minh chứng cho kỹ năng lập trình, làm việc nhóm và quản lý dự án của chúng tôi trong môn học Kỹ Năng Nghề Nghiệp.
...
\noindent\textbf{Combo:} Nếu bạn xóa nhiều hàng liên tiếp trong các lượt liên tiếp nhau, bạn sẽ nhận được điểm thưởng combo. Combo càng dài, điểm thưởng càng cao!
...
\noindent Mỗi khi bạn xóa được \textbf{10 hàng}, level sẽ tăng lên 1 và tốc độ rơi của các khối sẽ nhanh hơn. Điều này tạo nên sự thử thách không ngừng và khiến mỗi ván chơi đều gay cấn!
...
\noindent\textit{Lưu ý quan trọng:} Phiên bản hiện tại chỉ hỗ trợ hệ điều hành Unix-based (macOS và Linux). Game chưa hỗ trợ Windows do sử dụng các thư viện hệ thống POSIX (\texttt{termios}, \texttt{fcntl}) cho xử lý terminal.

\subsubsection {Hướng dẫn cài đặt}

Game được phát triển với \textbf{C++11}, sử dụng thư viện POSIX để xử lý terminal và đầu vào người dùng.

\textbf{Bước 1:} Tải xuống mã nguồn từ GitHub repository của chúng tôi:
\url{https://github.com/UIT-25730047/5ducks-tetris}
...
\textbf{Bước 3:} Biên dịch mã nguồn:
\vspace{-0.5\baselineskip}
\begin{itemize}
    \item Sử dụng lệnh: \texttt{g++ -std=c++11 main.cpp -o tetris}
\end{itemize}

\textbf{Bước 4:} Chạy game:
\vspace{-0.5\baselineskip}
\begin{itemize}
    \item Sử dụng lệnh: \texttt{./tetris}
\end{itemize}
...
\begin{enumerate}
    \item Pajitnov, A. (1985). \textit{Tetris - Game Design and Implementation}. Soviet Academy of Sciences, Moscow.

    \item The Linux Programming Interface Documentation. (n.d.). \textit{termios - Terminal I/O}. Retrieved from \url{https://man7.org/linux/man-pages/man3/termios.3.html}

    \item GitHub Documentation. (n.d.). \textit{GitHub Flow - Understanding the GitHub workflow}. Retrieved from \url{https://docs.github.com/en/get-started/quickstart/github-flow}

    \item Stevens, W. R., \& Rago, S. A. (2013). \textit{Advanced Programming in the UNIX Environment} (3rd ed.). Addison-Wesley Professional.

    \item Stroustrup, B. (2013). \textit{The C++ Programming Language} (4th ed.). Addison-Wesley Professional.
