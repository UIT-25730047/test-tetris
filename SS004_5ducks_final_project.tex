...
Retrieved from: \url{https://man7.org/linux/man-pages/man3/termios.3.html}
...
\vspace{-0.4\baselineskip}
\textbf{Ví dụ khối I ở góc xoay 0°:}
\begin{verbatim}
    [' ']['I'][' '][' ']
    [' ']['I'][' '][' ']
    [' ']['I'][' '][' ']
...
\begin{itemize}
    ...
    \end{itemize}
    \item \texttt{static void stopBackgroundSound()}: Kill afplay/aplay process với \texttt{pkill -f}
...
\vspace{-0.4\baselineskip}
\textbf{Private methods - High scores:}
\vspace{-0.6\baselineskip}
\begin{itemize}
...
\vspace{-0.4\baselineskip}
\textbf{Private methods - Terminal I/O:}
\vspace{-0.6\baselineskip}
\begin{itemize}
...
\vspace{-0.4\baselineskip}
\textbf{Private methods - Game logic:}
\vspace{-0.6\baselineskip}
\begin{itemize}
...
\vspace{-0.4\baselineskip}
\textbf{Thuật toán (TetrisGame.cpp:501):}
\vspace{-0.6\baselineskip}
\begin{verbatim}
for row = 0 to 3:
    for col = 0 to 3:
...
\vspace{-0.4\baselineskip}
\textbf{Thuật toán (TetrisGame.cpp:431):}
\vspace{-0.6\baselineskip}
\begin{verbatim}
...
\vspace{-0.4\baselineskip}
\textbf{Level progression (TetrisGame.cpp:644):}
...
\vspace{-0.4\baselineskip}
\textbf{Drop speed formula (computeDropSpeedUs):}
...
\subsubsection{Raw Mode Terminal Setup - enableRawMode()}
\vspace{-0.6\baselineskip}
...
\hline
\textbf{Tester} & \textbf{Test Scope} & \textbf{Bugs Found} \\
\hline
...
\vspace{-0.4\baselineskip}
\textbf{Bug fix rate:} 9/9 bugs fixed trong vòng 2 ngày (19-20/12).
...
Nhóm áp dụng GitHub Flow~\cite{github_flow} với 2-branch model:
